...
| image.name | string | `"tsa/task"` | The name of the Docker image |
...
| mongo.addr | string | `"mongodb://mongodb-0.mongodb:27017/task?replicaSet=rs0&authSource=admin"` | The address for MongoDB |
| mongo.dbname | string | `"task"` | The name of the MongoDB database |
| mongo.pass | string | `""` | The password for MongoDB |
| mongo.user | string | `""` | The username for MongoDB |
| name | string | `"task"` | The name of the application |
